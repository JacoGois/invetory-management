...
export const ModalFinancial = ({ isOpen, onClose, productId }) => {
  return (
   <Modal.Root isOpen={isOpen} onClose={onClose} size='4xl'>
     <Modal.Header text={productId ? 'Editar Aluno' : 'Adicionar Aluno'} />
     <Modal.Body>
       <div>
         <div className='flex flex-col w-full md:flex-row items-center md:gap-3'>
           ...
           <TextField label='Matrícula' className='w-full' placeholder='Ex.: 0123456789012' />
         </div>
         <div className='flex flex-col w-full md:flex-row items-center md:gap-3'>
